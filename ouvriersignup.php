...
<body>
   ...
   <?php include ('navbar.php');?>
    ...
    <div class="login-container">
        <div class="jumbotron">
            <h1 class="text-center">Inscription Ouvrier </h1>
        </div>
    </div>
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <form role="form" action="ouvrier_registered_success.php" method="POST">
                        ...
                        <label style="margin-left: 280px;">ou</label> <br>
                        <label style="margin-left: 150px; " class="submit"><a href="ouvrierlogin.php" style="color:blue;">Vous avez déjà un compte? Se connecter</a></label>
